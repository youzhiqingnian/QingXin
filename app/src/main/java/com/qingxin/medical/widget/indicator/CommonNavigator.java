...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private float mScrollPivotX = 0.85f; // 滚动中心点 0.0f - 1.0f
    ...
    private void init() {
        ...
        View root;
        if (mAdjustMode) {
            root = LayoutInflater.from(getContext()).inflate(R.layout.group_navigator_no_scroll, this);
        } else {
            root = LayoutInflater.from(getContext()).inflate(R.layout.group_navigator, this);
        }
            ...
            if (v instanceof View) {
                ...
                if (mAdjustMode) {
                    ...
                    if (view instanceof SimplePagerTitleView) {
                        SimplePagerTitleView simplePagerTitleView = (SimplePagerTitleView) view;
                        lp.setMargins(simplePagerTitleView.getMarginLeft(), 0, simplePagerTitleView.getMarginRight(), 0);
                    }
                }
