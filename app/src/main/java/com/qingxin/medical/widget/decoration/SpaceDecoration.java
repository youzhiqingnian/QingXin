package com.qingxin.medical.widget.decoration;
...
public class SpaceDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if ((position >= headerCount && position < parent.getAdapter().getItemCount() - footerCount)) {
            int gravity;
            if (spanIndex == 0 && spanCount > 1) gravity = Gravity.START;
            else if (spanIndex == spanCount - 1 && spanCount > 1) gravity = Gravity.END;
