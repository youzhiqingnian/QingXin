...
public class NetRequestListManager {
     ...
     * @return
     */
    public static Observable<HomeBanner> getBannerList(String limit) {
        return VLApplication.instance().getModel(RetrofitModel.class).getService(RetrofitService.class).getBannerList(limit);
    }
     ...
     * @return
     */
    public static Observable<GoddessDiary> getGoddessDiary(String limit, String skip) {
     ...
     * @return
     */
    public static Observable<HomeProduct> getHomeProductList(String limit, String skip, String isvip, String order) {
        return VLApplication.instance().getModel(RetrofitModel.class).getService(RetrofitService.class).getHomeProductList(limit, skip, isvip, order);
    }
